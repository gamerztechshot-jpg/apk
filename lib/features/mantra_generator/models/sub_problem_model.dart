// features/mantra_generator/models/sub_problem_model.dart

class SubProblem {
  final String id;
  final String mainProblemId;
  ...
  factory SubProblem.fromJson(Map<String, dynamic> json) {
    return SubProblem(
      id: json['id'] as String,
      mainProblemId: json['main_problem_id'] as String,
